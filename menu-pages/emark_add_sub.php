...
{
	$quiz_n = strip_tags($_POST['qz_n']);
	$sub_id = strip_tags($_POST['sub_nm']);
	$tot_m = strip_tags($_POST['tot_m']);
	$min_pass = strip_tags($_POST['min_pass']);
...
if(isset($_POST['update_name']))
{
	...
	$up_su_ss = strip_tags($_POST['sub_nm']);
	$up_su_tm = strip_tags($_POST['tot_m']);
	$up_su_mp = strip_tags($_POST['min_pass']);
